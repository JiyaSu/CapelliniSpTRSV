...
#include "read_mtx.h"
#include "tranpose.h"
#include "spts_syncfree_cuda_csr.h"
...
int main(int argc, char ** argv)
{
    ...
    //printf("name,nnz,layer,parallelism,solve_time(ms),gflops,bandwith(GB/s)\n");
    ...
    int layer;
    double parallelism=0,solve_time=0,gflops=0,bandwith=0,pre_time=0;
    ...
    spts_syncfree_cuda_csr(csrRowPtrL_tmp, csrColIdxL_tmp, csrValL_tmp, m, n, nnzL,
