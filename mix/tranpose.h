                    ...
                    )
{
    ...
    printf("%d,%lg\n",warp_greater,((double)warp_greater)/(warp_greater+warp_lower));
}

void matrix_warp2    (const int         m,
                     const int         n,
                     const int         nnz,
                     const int        *csrRowPtr,
                     const int        *csrColIdx,
                     ...
                     )
{
    ...
    int *warp_num=(int *)malloc((Len)*sizeof(int));
    if (warp_num==NULL)
        printf("warp_num error\n");
    memset (warp_num, 0, sizeof(int)*(Len));
    ...
    *Len_add=Len;
    *warp_num_add=warp_num;
}

void matrix_warp3    (const int         m,
                      const int         n,
                      const int         nnz,
                      const int        *csrRowPtr,
                      const int        *csrColIdx,
